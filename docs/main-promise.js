const createRequestPromise = url => {
...
const getPromise = async () => {
	try {
		const data = await createRequestPromise('https://randomuser.me/api')
...
document
	.getElementById('btnGeneratePerson-promise')
	.addEventListener('click', getPromise)
